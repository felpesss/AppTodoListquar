                ...
                case 2 -> {
                    ...
                    if (tarefas.isEmpty()) {
                        ...
                        for (Tarefas t : tarefas) {
                            System.out.println("ID: " + t.getId() + ", Título: " + t.getTitulo() + ", Descricao: " + t.getDescricao() + ", Completa: " + (t.isCompleta() ? "Sim" : "Não") + ", Data: " + t.getDataAgora());
                        }
                    }
                }
                case 3 -> {
                    ...
                    if (tarefaParaAtualizar.isPresent()) {
                        ...
                        System.out.println("Tarefa com ID " + idAtualizar + " nao encontrada.");
                    }
                }
                case 4 -> {
                    ...
                    if (servico.removerTarefa(idRemover)) {
                        ...
                        System.out.println("Tarefa com ID " + idRemover + " nao encontrada.");
                    }
                }
                case 5 -> {
                    System.out.println("Saindo do gerenciador de tarefas. Ate mais!");
                    entrada.close();
                    System.exit(0);
                }
